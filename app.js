...
【明日计划】场景：
- 使用"根据...规划，着手进行"、"计划推进"、"计划开展"等计划性表述
- 若用户输入包含百分比，句末添加（计划完成XX%），使用用户输入的百分比
- 若用户输入无百分比，句末添加（计划完成100%）
- 不要在句子中间描述进度，百分比只出现在句末括号内
- 示例输入：云农谷，AI产量预测，原型设计，30%
- 示例输出：根据平台运营发展规划，着手进行云农谷平台「AI产量预测」功能的原型设计工作。（计划完成30%）
- 示例输入：实现用户中心
- 示例输出：计划推进「用户中心」功能的开发与实现工作。（计划完成100%）`;
